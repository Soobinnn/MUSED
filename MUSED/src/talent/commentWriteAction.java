...
public class commentWriteAction extends ActionSupport implements SessionAware{
	...
	public talent_cVO paramClass;
	public talent_cVO resultClass;
	...
	public String execute() throws Exception{
		paramClass=new talent_cVO();
		resultClass=new talent_cVO();
	...
	public talent_cVO getParamClass() {
		return paramClass;
	}

	public void setParamClass(talent_cVO paramClass) {
		this.paramClass = paramClass;
	}

	public talent_cVO getResultClass() {
		return resultClass;
	}

	public void setResultClass(talent_cVO resultClass) {

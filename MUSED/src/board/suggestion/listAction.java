...
public class listAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		list = sqlMapper.queryForList("sug.selectAll");
	  ...
	  public String search() throws Exception{
		  ...
		  if(searchNum ==0) {
			  list = sqlMapper.queryForList("sug.selectSearchW", "%"+getSearchKeyword()+"%");
		  }
		  if(searchNum ==1) {
			   list = sqlMapper.queryForList("sug.selectSearchS", "%"+getSearchKeyword()+"%");
		  }
		  if(searchNum ==2) {
			   list = sqlMapper.queryForList("sug.selectSearchC", "%"+getSearchKeyword()+"%");
		  }
